...
if 'vectorstore' not in st.session_state:
    ...
    db = chromadb.PersistentClient(path="C:\\Users\\Gaurav Jetley\\OneDrive - Colostate\\RAG_LLM\\Tests/chroma_db/chroma_db")
    ...
    st.session_state.vectorstore = Chroma(
        ...
        persist_directory="C:\\Users\\Gaurav Jetley\\OneDrive - Colostate\\RAG_LLM\\Tests/chroma_db/chroma_db"
    )
...
#             # Render the assistant's response in markdown
